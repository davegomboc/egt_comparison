...
#define TB_RESULT_WDL_MASK          UINT32_C(0x0000000F)
#define TB_RESULT_TO_MASK           UINT32_C(0x000003F0)
#define TB_RESULT_FROM_MASK         UINT32_C(0x0000FC00)
#define TB_RESULT_PROMOTES_MASK     UINT32_C(0x00070000)
#define TB_RESULT_EP_MASK           UINT32_C(0x00080000)
#define TB_RESULT_DTZ_MASK          UINT32_C(0xFFF00000)
